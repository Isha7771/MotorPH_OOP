...
public class HrFrame extends JFrame {
    ...
    private final JLabel lblTitle = new JLabel("HR Dashboard");
    ...
    private static final String PAGE_EMPLOYEES  = "employees";

    public HrFrame(String employeeNo, String lastName, String firstName) {
        super("MotorPH - HR");
        ...
        showPage(PAGE_ATTENDANCE, "Attendance Monitoring");
    }
    ...
    private JComponent buildSidebar() {
        ...
        side.add(sideTitle("HR Staff"));
        side.add(Box.createVerticalStrut(14));

        side.add(navButton("Attendance Monitoring", PAGE_ATTENDANCE));
        side.add(Box.createVerticalStrut(10));
        side.add(navButton("Employee Management", PAGE_EMPLOYEES));
    ...
    private void registerPages() {
        contentPanel.add(new HrAttendanceMonitoringPage(), PAGE_ATTENDANCE);
        contentPanel.add(new HrEmployeeManagementPage(), PAGE_EMPLOYEES);
    }
