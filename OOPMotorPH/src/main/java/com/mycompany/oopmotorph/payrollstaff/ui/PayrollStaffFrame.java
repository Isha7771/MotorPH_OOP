...
public class PayrollStaffFrame extends JFrame {
    ...
    private final JLabel lblTitle = new JLabel("Payroll Staff Dashboard");
    ...
    private static final String PAGE_PROCESSING = "processing";

    public PayrollStaffFrame(String employeeNo, String lastName, String firstName) {
        super("MotorPH - Payroll Staff");
    ...
    private JComponent buildSidebar() {
        ...
        side.add(sideTitle("Payroll Staff"));
        side.add(Box.createVerticalStrut(14));

        side.add(navButton("Attendance", PAGE_ATTENDANCE));
        side.add(Box.createVerticalStrut(10));
        side.add(navButton("Payroll Processing", PAGE_PROCESSING));
    ...
    private void registerPages() {
        contentPanel.add(new PayrollAttendancePage(), PAGE_ATTENDANCE);
        contentPanel.add(new PayrollProcessingPage(), PAGE_PROCESSING);
    }
